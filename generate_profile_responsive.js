        ...
        <div class="container profile-layout">
          ...
          <div class="profile-sidebar" style="display: flex; flex-direction: column; gap: 1rem;">
            ...
            <div style="background: #f4f5f6; padding: 1.5rem; border-radius: var(--radius-sm);">
              <h3 id="sidebar-name" style="font-size: 1.1rem; margin-bottom: 0.2rem;">...</h3>
              <p id="sidebar-email" style="font-size: 0.85rem; color: var(--gray-dark); margin-bottom: 0.5rem;">...</p>
              <p id="sidebar-role" style="font-size: 0.8rem; color: #e03131;">...</p>
            </div>

            <!-- Sidebar Nav Links -->
            <div class="profile-sidebar-links" style="display: flex; flex-direction: column; border: 1px solid #e9ecef; border-radius: var(--radius-sm);">
              <a href="#">
              ...
              <a href="#">FAQs</a>
              <a href="#" style="color: var(--primary); font-weight: 600;">Profile</a>
              <!-- membership -->
              <a href="#" style="color: #e03131;">My Membership</a>
            </div>
          ...
          <div class="profile-content">
            ...
            <div class="profile-box">
              ...
              <div class="profile-blocks-grid" style="margin-bottom: 1.5rem;">
                <!-- Left Col -->
...
// Replace script logic slightly for profile
let rebuilt = headerMatch + mainContent + footerMatch;
rebuilt = rebuilt.replace('<script type="module" src="./js/pages/home.js"></script>', '<script type="module" src="./js/pages/profile.js"></script>');

fs.writeFileSync('profile.html', rebuilt);
console.log('Done rendering responsive layout onto profile.html');
