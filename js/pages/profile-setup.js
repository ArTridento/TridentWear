import { post, saveAuthSession, getAuthSession } from "../shared/api.js?v=7";
import { initSite, showToast, getCurrentUser } from "../shared/site.js?v=7";
...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  const { getAuthSession } = await import("../shared/api.js?v=7");
