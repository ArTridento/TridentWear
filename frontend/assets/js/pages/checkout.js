import { STATIC_MODE, post } from "../shared/api.js?v=9";
import { clearCart, getCartSubtotal, loadCart } from "../shared/cart.js?v=9";
import { formatCurrency, getCurrentUser, initSite, showToast } from "../shared/site.js?v=9";
  ...
  document.querySelector("[data-order-status]").innerHTML = `
    <div class="order-success-card">
      ...
      <div style="display:flex;gap:0.75rem;flex-wrap:wrap;justify-content:center;margin-top:1rem;">
        <a class="btn btn-primary" href="/track?id=${orderId}">Track Order</a>
