...
async function loadProductDetail() {
  ...
  if (!idStr || isNaN(fallbackId)) {
    statusContainer.innerHTML = '<p style="color:var(--danger); font-weight:bold;">Product not found or invalid ID.</p><a href="/products" class="btn btn-outline" style="margin-top:1rem;">Back to Shop</a>';
    return;
  }
  ...
  try {
    ...
    if (!product) {
      statusContainer.innerHTML = '<p style="color:var(--danger); font-weight:bold;">Product not found.</p><a href="/products" class="btn btn-outline" style="margin-top:1rem;">Back to Shop</a>';
      return;
    }
    ...
    statusContainer.innerHTML = '<p style="color:var(--danger); font-weight:bold;">Failed to load product details.</p><a href="/products" class="btn btn-outline" style="margin-top:1rem;">Back to Shop</a>';
  }
}
